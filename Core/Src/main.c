...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, SWITCH_HOLDOFF_Pin|SWITCH_DIVISION_Pin|SWITCH_CURRENT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : SWITCH_HOLDOFF_Pin SWITCH_DIVISION_Pin SWITCH_CURRENT_Pin */
  GPIO_InitStruct.Pin = SWITCH_HOLDOFF_Pin|SWITCH_DIVISION_Pin|SWITCH_CURRENT_Pin;
